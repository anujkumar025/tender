...
function SelectBest() {
    ...
    const handleFileChange = (event, inputType) => {
        ...
        if (inputType === 1) {
            ...
            setProposalFiles(selectedFiles); // Update Proposal files state
            console.log("Proposal files:", selectedFiles);
        }
        } catch (error) {
            ...
            <div className='grid grid-cols-2 gap-4 place-content-center row-start-2 row-span-8 w-full h-full -translate-y-18'>
                ...
                <div>
                    ...
                    {proposalFiles.length > 0 && (
                        <ScrollArea className="h-72 w-48 rounded-md border mt-2">
                        <div className="p-4">
